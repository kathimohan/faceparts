...
lleft =lright=face_landmarks_list[0]['left_eye'][0][1]
ltop =lbottom= face_landmarks_list[0]['left_eye'][0][0]
for k1 in k :
	if(ltop>k1[0]):
		ltop=k1[0]
	if(lbottom<k1[0]):
...
#im = im.crop((lleft-2, ltop-2, bottom+2,right+2))
im = im.crop((ltop-2, lleft-2, bottom+2,right+2))
